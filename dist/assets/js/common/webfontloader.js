...
var custom = {
  custom: {
    ...
    urls: [// './css/vendor/feather-1.1.css',
    ...
    './css/fonts/raleway.css' // './css/fonts/roboto-condensed.css',
...
WebFont.load(custom // custom (no need to link css from index.html)
